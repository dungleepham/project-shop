                                    ...
                                    <table class="table table-responsive-md">
                                        ...
                                        @foreach($all_category_product as $key => $cate_pro)
                                            <tr>
                                                ...
                                                <td><div> <span class="w-space-no" style="color:black">{{$cate_pro->category_name}}</span></div></td>
                                                <td style="color:black">
                                                    <?php
                                                        if($cate_pro->category_status == 0)
                                                        {
                                                            ?>
                                                        <a href="{{URL::to('/active-category-product/'.$cate_pro->category_id)}}"> <i class="fa-eye-styling fa fa-eye-slash" aria-hidden="true"> </i> </a>
                                                    <?php
                                                        }
                                                        else{
                                                    ?> 
                                                        <a href="{{URL::to('/unactive-category-product/'.$cate_pro->category_id)}}"> <i class="fa-eye-styling fa fa-eye" aria-hidden="true"></i> </a>
                                                    <?php 
                                                        }
                                                    ?>
                                                ...
                                                <td>
													<div class="d-flex">
														<a href="{{URL::to('/edit-category-product/'.$cate_pro->category_id)}}" class="btn btn-primary shadow btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
														<a onclick="return confirm('Bạn muốn xóa mục này?')" href="{{URL::to('/delete-category-product/'.$cate_pro->category_id)}}" class="btn btn-danger shadow btn-xs sharp"><i class="fa fa-trash"></i></a>
													</div>
												</td>
                                            </tr>
                                        @endforeach    
